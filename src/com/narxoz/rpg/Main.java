...
public class Main {
    public static void main(String[] args) {
        ...
        queue.executeAll();
        System.out.println("Opponent HP after attack command: " + opponent.getHealth());
        System.out.println("Hero HP after heal/defend commands: " + hero.getHealth() +
            " | dodge chance: " + String.format(Locale.US, "%.2f", hero.getDodgeChance()));
